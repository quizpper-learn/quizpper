    ...
    <div class="container">
        <div class="flat-form">
            <ul class="tabs">
                ...
                <a href="<?php $this->load->helper('url'); ?>/admin"><i class="fa-solid fa-xs fa-chalkboard-user"></i></a>
            </ul>
            <div id="login" class="form-action show">
                ...
                <form action="<?= base_url('Login/actlogin'); ?>" method="POST">
                    <ul>
                        <li>
                            <input type="text" class="form-control" name="nis" placeholder="NIS" autofocus required="" />
                        </li>
                        <li>
            ...
            <div id="register" class="form-action hide">
                ...
                <form>
                    <ul>
                        ...
                        <li>
                            <input class="form-control" type="submit" value="Sign Up" class="button" />
                        </li>
                    </ul>
                </form>
            </div>
            ...
            <div id="reset" class="form-action hide">
                ...
                <form class="formnis">
                    <ul>
                        <li>
                            <input class="form-control" id="fnis" type="text" name="nis" placeholder="NIS" required>
                        </li>
                        <li>
                            <p class="error-redB" style="color:white;padding: 10px; background-color: gray;border-radius: 5px; margin-bottom:10px;">
                ...
                <form class="formjawab">
                    <ul>
                        ...
                        <li>
                            <input type="text" id="fjawab" class="jawab form-control" placeholder="Jawaban" required>
                        </li>
                        <li>
                            <p class="error-redB" style="color:white;padding: 10px; background-color: gray;border-radius: 5px; margin-bottom:10px;">Jawaban Anda Salah !</p>
                        </li>
                        <li>
                ...
                <form method="post" action="<?= base_url('Login/resetpasswd'); ?>" class="formreset">
                    ...
                    <input class="form-control" type="password" id="passwd" name="password" placeholder="Masukkan Password Baru" required>
                    <input class="form-control" type="password" id="repasswd" name="repassword" placeholder="Masukkan Kembali Password" required>
                    <p class="error-redB" style="color:white;padding: 10px; background-color: gray;border-radius: 5px; margin-bottom:10px;">Password Tidak Cocok !</p>
