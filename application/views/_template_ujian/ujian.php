		...
		<div class="box box-primary">
			<form name="_form" method="post" id="_form">
				...
				<div class="box-footer">
					<div class="col-sm-4 mt-5 bf-kri">
						<a class="action btn back btn-warning" style="width: 120px;"><i class="fa fa-chevron-left"></i>Sebelumnya</a>
					</div>
					<div class="col-sm-4 mt-5 bf-kri">
						<a class="action btn simpan btn-default" style="width: 120px;">Simpan</a>
					</div>
					<div class="col-sm-4 mt-5 bf-kri">
						<a class="text-center action btn next btn-warning" style="width: 120px;">Selanjutnya<i class="fa fa-chevron-right"></i></a>
					</div>
					<div class="col-sm-4 mt-5 bf-kri" style="width: 80px;">
						<a class="action submit btn btn-success" style="width: 120px;"><i class="fa fa-check"></i>Selesai</a>
					</div>
				</div>
