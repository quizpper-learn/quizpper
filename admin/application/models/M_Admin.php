...
class M_Admin extends CI_Model
{
    ...
    function delete_guru($where, $table, $id_guru)
    {
    ...
    function delete_mapel($where, $table, $id_mapel)
    {
    ...
    function delete_kelas($where, $table, $id_kelas)
    {
    ...
    function delete_jurusan($where, $table, $id_jurusan)
    {
