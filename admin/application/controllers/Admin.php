...
class Admin extends CI_Controller
{
	...
	public function hapus_guru($id)
	{
		...
		$where = array('id_guru' => $id);
		$this->m_admin->delete_guru($where, 'guru', $id);
		redirect('guru');
	}
	...
	public function hapus_mapel($id)
	{
		...
		$where = array('id_mapel' => $id);
		$this->m_admin->delete_mapel($where, 'mapel', $id);
		redirect('mapel');
	}
	...
	public function hapus_siswa($id)
	{
		...
		$where = array('id_siswa' => $id);
		$this->m_admin->delete_siswa($where, 'siswa', $id);
		redirect('siswa');
	}
	...
	public function hapus_kelas($id)
	{
		...
		$where = array('id_kelas' => $id);
		$this->m_admin->delete_kelas($where, 'kelas', $id);
		redirect('kelas');
	}
	//Jurusan
	...
	public function hapus_jurusan($id)
	{
		...
		$where = array('id_jurusan' => $id);
		$this->m_admin->delete_jurusan($where, 'jurusan', $id);
		redirect('kelas');
	}
	...
	{
		$this->db->query("DELETE FROM ikut_ujian WHERE id_ujian=" . $id);
